...
public class DriveToDistanceCommand extends BaseCommand {
    ...
    @Inject
    public DriveToDistanceCommand(DriveSubsystem driveSubsystem, PoseSubsystem pose, PIDManagerFactory pidManagerFactory) {
    ...
    public DriveToDistanceCommand withTargetDistance(double distance) {
        // Note: does not apply to the current run while the command is running
    ...
    public void initialize() {
        ...
        pid.reset();
        targetPosition = pose.getPosition() + targetDistance;
    }
